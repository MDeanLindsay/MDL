...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://www.canva.com/design/DAF0ZPizFXw/USPafcbcuNXc4oEC8CZs1Q/view?utm_content=DAF0ZPizFXw&utm_campaign=designshare&utm_medium=link&utm_source=editor" variant="secondary" className="group mt-6 w-full">
        Download CV
